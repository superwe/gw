    ...
    $(function(){
                ...
                function userSelector( options){
                    ...
                    var dialog_obj = new YY.SimpleDialog({
                     ...
                     'hasHeader' : true,
                     'hasFooter' : false,
                     'url':"/space/employee/selectEmployee.html",
                     'onComplete': function($wrap){ //弹出页面成功后 所做操作
                        ...
                        //绑定事件
                         ...
                         function initEmployeeNum(){
                             ...
                             $.post("/space/employee/ajaxGetEmployeeNumForSelectEmployee.html",{ searchKey:searchKey},function(jsonData){
                                 if(jsonData==null){
                                     return;
                                 }else{
                         ...
                         function initFans(){
                             ...
                             var searchKey = getSearchKey();
                             $.post("/space/employee/ajaxGetFansForSelectEmployee.html",{ searchKey:searchKey},function(jsonData){
                                 if(jsonData==null){
                                     return;
                                 }else{
                         ...
                         function initSameDeptEmployees(){
                             ...
                             var searchKey = getSearchKey();
                             $.post("/space/employee/ajaxGetSameDeptEmployeeForSelectEmployee.html",{ searchKey:searchKey},function(jsonData){
                                 if(jsonData==null){
                                     return;
                                 }else{
                         ...
                         function initAllEmployees(){
                             ...
                             var searchKey = getSearchKey();
                             $.post("/space/employee/ajaxGetAllEmployeeForSelectEmployee.html",{ searchKey:searchKey},function(jsonData){
                                 if(jsonData==null){
                                     return;
                                 }else{
                         ...
                         function getHtml(jsonData){
                             ...
                             for(var i=0;i<jsonData.length;i++){
                                 ...
                                 ret.push("<img src='http://esnimage.uu.com.cn/qz/avatar/000/01/61/84.jpg.thumb.jpg'>");// todo 人员头像
