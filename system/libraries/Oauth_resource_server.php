...
class Oauth_resource_server
{
	...
	public function init()
	{
		...
		if ($access_token)
		{
			$session_query = $this->ci->db->get_where('tb_oauth_sessions', array('access_token' => $access_token, 'stage' => 'granted'));
			...
			if ($session_query->num_rows() === 1)
			{
				...
				$scopes_query = $this->ci->db->get_where('tb_oauth_session_scopes', array('access_token' => $access_token));
