...
class CI_Cache_redis extends CI_Driver
{
	...
	/**
	 * 这样就不需再次类里实现redis扩展的方法了 added by bishenghua 2013/04/28
	 * @see CI_Driver::__call()
	 */
	public function __call($name, $arguments)
	{
		if (!method_exists($this->_redis, $name)) return false;
    ...
    protected function _setup_redis()
    {
        ...
        try
        {
            ...
            //$this->_redis->setOption(Redis::OPT_SERIALIZER, Redis::SERIALIZER_PHP); //这样可以直接存储数组了 added by bishenghua 2013/05/07
        }
